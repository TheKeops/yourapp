...
<p align="left">
  <a href="README.md"><img width="64" height="64" alt="Turkish Language" src="https://github.com/user-attachments/assets/dcf625d0-0bbf-41f2-bae9-eb7343c57004" /></a>
  <br>
...
```mermaid
graph TD
    A[User Options] --->|Prompt| C(Gemini AI API)
    C -->|Code Generation| D[Python Source Code]
    D --> E{Compilation}
    E -->|PyInstaller/Compiler| F[Executable File .exe]
    F --> G[Delivered to User]
```
